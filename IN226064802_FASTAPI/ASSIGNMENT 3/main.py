...
products = [
    ...
    {"id":4,"name":"Keyboard","price":899,"category":"Electronics","in_stock":True},
...
@app.get("/")
def read_root():
    return {"message": "Welcome to My E-commerce API! Visit /docs for API documentation."}
...
def restock_product(product_id: int, in_stock: bool):
...
def delete_product(product_id: int):
    ...
    for product in products:
        if product["id"] == product_id:
            ...
            return {
                "message": f"{product['name']} removed successfully"
            }
